...
class GccFlagsTuner(MeasurementInterface):
	def manipulator(self):
		...
		manipulator.add_parameter(stringParameter('opt_level', 0, 3)) #levels -o -01 -02 -03
...
def run(self, desired_result, input, limit):
	...
	gcc_cmd = 'gcc downloading_wall_restitution_GPU.c -o ./tmp.bin -std=c11 -lgsl -lgslcblas -lm'
	...
	for flag in GCC_FLAGS:
		...
		run_result = self.call_program('./tmp.bini 0.0001 8 10 0.09') #o binario é executado aqui
